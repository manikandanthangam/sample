        ...
        return(
            <div className='container' id='DashboardContainer'>
                <div className="row chart-row">
                    <div className="col-3 col-md-3 tablecol">
                        <CommonTable data={this.commentsData} header={this.headerData}></CommonTable>
                    </div>
                    <div className="col-9 col-md-9 chartcol">
                        <div className="row chart-innerrow">
                            <div className="col-6 col-md-6 chart-innercol">
                            <Charts data={data} maptype='doughnut'></Charts>
                            </div>
                            <div className="col-6 col-md-6 chart-innercol">
                            <Charts data={data} maptype='pie'></Charts>
                            </div>
                        </div>
                        <div className="row chart-innerrow">
                            <div className="col-6 col-md-6 chart-innercol">
                            <Charts data={data} maptype='line'></Charts>
                            </div>
                            <div className="col-6 col-md-6 chart-innercol">
                            <Charts data={data} maptype='bar'></Charts>
                            </div>
                        </div>
                    </div>
                </div>
                {/* <div className="row chart-row">
                    <div className="col-md-6 chart-col">
