...
class Charts extends Component {
	...
	GenerateChart() {
		...
		// console.log('test');
		// employeeJsonData = JSON.parse(employeeData);
		// console.log(employeeData);
		let emplength = employeeData.length;
		// console.log(emplength);
		let Below30Arr = [];
		let Upto50Arr = [];
		let Above50Arr = [];
		for (let i = 0; i < emplength; i++) {
			let Age = employeeData[i].Age;
			if (Age < 30) {
				Below30Arr.push(Age);
		...
		// console.log(Below30Arr);
		// console.log(Upto50Arr);
		// console.log(Above50Arr);
		
		let below30 = Below30Arr.length;
		let upto50 = Upto50Arr.length;
		let above50 = Above50Arr.length;
		
		this.mapdata.datasets[0].data = [below30, upto50, above50];
	...
	render() {
		...
		// console.log(this.mapdata);
		let MapDisplay = "";
		if(this.maptype === "doughnut"){
			MapDisplay = <Doughnut data={this.mapdata}></Doughnut>
		} else if(this.maptype === "line"){
			MapDisplay = <Line data={this.mapdata}></Line>
		} else if(this.maptype === "bar"){
			MapDisplay = <Bar data={this.mapdata}></Bar>
		} if(this.maptype === "pie"){
			MapDisplay = <Pie data={this.mapdata}></Pie>
		}

		return (
			<div id='ChartContainer'>
				{MapDisplay}
				{/* <Doughnut data={this.mapdata}></Doughnut> */}
				{/* <Line data={this.mapdata}></Line> */}
				{/* <Bar data={this.mapdata}></Bar> */}
				{/* <Pie data={this.mapdata}></Pie> */}

				{/* <input type='button' onClick={() => this.GenerateChart()} value='Generate data' /> */}
			</div>
		);
	}
}
